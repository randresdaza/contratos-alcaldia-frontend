<template>
  <div class="q-pa-md">
    <q-form @submit="addData">
      <div class="row items-center">
        <q-input class="q-mb-md q-pt-md q-pb-md" style="width: 300px;max-width: 80vw; max-height: 80vw;" filled
          v-model="formData.nombre" label="Nombre de la Subserie" type="text" lazy-rules
    ...
    <q-table class="my-sticky-virtscroll-table q-mt-xs col justify-center" virtual-scroll flat bordered title="Subseries"
